...
if __name__ == "__main__":
    studentsUrl = 'https://651313e18e505cebc2e98c43.mockapi.io/students'
    pupilsUrl = 'https://651313e18e505cebc2e98c43.mockapi.io/pupils'
    ...
    mappingMock = {
        ...
        "mapped": {
            ...
            "dateOfBirth": {
                ...
                "conditions": [],
                "api1DateFormat": "%Y-%m-%dT%H:%M:%S.%fZ",
                "api2DateFormat": "%Y-%m-%dT%H:%M:%S.%fZ"
            },
            "address": {
                "transformation": "toString",
                "source_fields": [
            ...
            "createdAt": {
                ...
                "conditions": [],
                "api1DateFormat": "YYYY-MM-DDTHH:MM:SS.SSSZ",
                "api2DateFormat": "YYYY-MM-DDTHH:MM:SS.SSSZ"
            },
            "typeTest1": {
                "transformation": "toString",
                "source_fields": [
    ...
    pipeline = Pipeline(pupilsUrl, studentsUrl, mappingMock["mapped"])

    mapped_data = pipeline.map_data(10)
    for item in mapped_data:
        print(item)

    # generate_pipeline(mapped_data, studentsUrl)